...
void MasterProtocols::inquiryRequest(AbstractProtocolsTransfers *p_transfers,
...
void MasterProtocols::focusRequest(AbstractProtocolsTransfers *p_transfers,
...
void MasterProtocols::takePictureRequest(AbstractProtocolsTransfers
                                             *p_transfers,
                                         uchar (*data)[RequestCommandBuffSize],
...
void MasterProtocols::getPicturePackRequest(AbstractProtocolsTransfers
    *p_transfers, uchar (*data)[RequestCommandBuffSize],
