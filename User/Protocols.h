...
class MasterProtocols
{
  public:
    ...
    static uchar packAnswerCommand(AbstractProtocolsTransfers
                                       *p_transfers);
    static void inquiryRequest(AbstractProtocolsTransfers *p_transfers,
                               uchar (*data)[RequestCommandBuffSize]);
    static void focusRequest(AbstractProtocolsTransfers *p_transfers,
                             uchar (*data)[RequestCommandBuffSize], const FocusRequest focus,
                             const Zoom zoom = 0);
    static void takePictureRequest(AbstractProtocolsTransfers
                                       *p_transfers,
                                   uchar (*data)[RequestCommandBuffSize],
                                   const TakePictureInfo *p_info);
    static void getPicturePackRequest(AbstractProtocolsTransfers
                                          *p_transfers,
                                      uchar (*data)[RequestCommandBuffSize],
    ...
    static ErrorCode takePictureAnswer(AbstractProtocolsTransfers
                                           *p_transfers, PicturePackInfo *p_info);
